...
map2
```
From the map we can find that there at 4 remarkable bright blue area represented by the top four population states in America, suggesting us that it is better to live in less populous area when meeting series Epidemic disease.
---
class:inverse,middle,center
#4.Predicting positive results of COVID-19 
